describe "Ionic autocompletions", ->
  [editor, provider] = []
  ...
  beforeEach ->
    waitsForPromise -> atom.packages.activatePackage('autocomplete-ionic')
    waitsForPromise -> atom.packages.activatePackage('language-html')

    runs ->
      provider = atom.packages.getActivePackage('autocomplete-ionic').mainModule.getProvider()
